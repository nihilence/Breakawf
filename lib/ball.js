(function () {
  ...
  var Ball = Breakoff.Ball = function (options) {
    ...
    this.boing = new Audio("assets/boing.wav");
    this.squish = new Audio("assets/squish.wav");
    this.img = new Image();
  ...
  Ball.prototype.draw = function (ctx) {
    ...
    if(this.img.complete){
      ctx.drawImage(that.img, that.pos[0]-20, that.pos[1]-20);
    }else {
  ...
  Ball.prototype.move = function () {
    rad = this.radius
    //Bounds check to bounce off wall
